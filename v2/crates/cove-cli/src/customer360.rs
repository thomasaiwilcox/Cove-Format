    ...
    json!({
        ...
        "recommended_queries": [
            ...
            },
            {
                ...
                "command": "cove query customers.cove 'table(customer_evidence).select(source_id, rows: count(*))'"
            },
            {
        ...
        "benchmark_cases": [
            ...
            "customer360_evidence_aggregate",
            "customer360_customer_event_join",
...
It demonstrates COVE as a semantic archive: CRM, support, and billing sources
are mapped into canonical customer objects with queryable evidence and projected
table readback.
...
cove query customers.cove 'table(customer_evidence).select(source_id, rows: count(*))'
