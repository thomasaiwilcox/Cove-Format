...
use cove_core::{
    artifact::{
        coveai::{
            ...
            AI_COMPANION_ARTIFACT_KIND_CVV2, AI_POLICY_KIND_VISIBILITY, AI_SOURCE_KIND_COVE_FILE,
    ...
    constants::{
        ...
        PrimaryProfile, SectionKind, StorageClass, ValueTag, AI_FEATURE_VECTOR,
        FEATURE_CODEC_EXTENSION_REGISTRY, FEATURE_CODEC_LZ4, FEATURE_CODEC_ZSTD,
