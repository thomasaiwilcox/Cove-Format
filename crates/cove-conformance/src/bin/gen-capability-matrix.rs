...
fn rows() -> Vec<Row> {
    vec![
        ...
        Row {
            ...
            validated: "yes",
            written: "yes",
            notes: "artifact/coveai.rs validates `CVA2`/`CVV2` tail discovery, postscript/header/directory CRCs, section bounds/non-overlap, `AiRecordHeaderV1`, required/optional record flag semantics, unknown-record skip/CRC semantics, scoped unknown required AI features and record kinds, operation-needed section scoping, reference tables, source binding, privacy summaries, payload refs, payload integrity, external asset digest requirements, Phase 1 token/vector payload-carrier rules, COVE-CHUNK/TOK/VEC/TRAIN/MMSEQ descriptors, tensor/assets, generator provenance descriptors, vector composition/index descriptors, COVE-VEC V2 model-input identity and descriptor-level vector dedup rules, shared COVE-AI payload leases, exact flat vector scan across FileCode/chunk/object/association/training/asset/multimodal bindings, direct vectorRef embedding lookup, and descriptor-bundle writing for all modeled AI descriptor families; COVE-MAP parses and validates `MAP_AI_*` slot policy catalogs; CoveQL-AI parses/plans the AI profile and executes `.embedding(fileCode|vectorRef)`, `.similar(fileCode|vectorRef, k, target, index)`, advisory `.hybrid(...)`/`.rerank(...)`, `.chunks()`, `.tokens()`, `.context()`, `.asPromptContext()`, `.trainingSamples()`, `.split()`, `.pack()`, `.multimodal()`, and `.generatorAudit()` through supplied or auto-discovered sibling sidecars with policy-gated payload exposure and withheld diagnostics; `cove ai export` and `cove train export` write JSON/JSONL/HF-JSONL plus native Arrow IPC, Parquet, and WebDataset-style tar record streams with smoke tests checking binary artifact signatures",
        },
        Row {
            section: "§8",
        ...
        Row {
            section: "§20.8",
            capability: "COVE-CX codec descriptors",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
        ...
        Row {
            section: "§20.9",
            capability: "Registered encoding envelopes",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
        ...
        Row {
            section: "§29.3",
            capability: "COVE-COVERAGE providers and sets",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
            notes: "cove-coverage parses and serializes provider descriptors, coverage set headers, entries, checksums, ordering, conservative proof flags, and pruning-safety with coverage/ corpus vectors",
        },
        Row {
            section: "§29.3.3",
            capability: "COVE-COVERAGE proof records",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
        ...
        Row {
            section: "§29.4",
            capability: "COVE-COVERAGE predicate forms",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
        ...
        Row {
            section: "§29.5",
            capability: "COVE-COVERAGE plan candidates",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
            notes: "cove-coverage structurally parses and serializes costed plan candidates, validates unique candidate IDs, provider/predicate refs, cost sanity, fallback policy, and fail-closed under-inclusive pruning flags",
        },
        Row {
            section: "§30",
        ...
        Row {
            section: "§33.1",
            capability: "COVE-I secondary index artifact framing",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
        ...
        Row {
            section: "§33.2",
            capability: "COVE-I index-only capability records",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
        ...
        Row {
            section: "§67.5",
            capability: "COVE-L layout plans",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
            notes: "cove-layout parses, validates, and serializes layout headers/nodes; layout/ corpus covers checksums, duplicate node IDs, child ranges, root constraints, and valid plans",
        },
        Row {
            section: "§67.6",
            capability: "COVE-L scan split index",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
            notes: "cove-layout parses and serializes scan split headers/entries, validates unique split IDs and row ranges, and gates layout/ scan split vectors",
        },
        Row {
            section: "§67.8",
            capability: "COVE-R runtime compatibility hints",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
        ...
        Row {
            section: "§69.5",
            capability: "COVE-CACHE runtime coverage cache",
            modeled: "yes",
            parsed: "yes",
            validated: "yes",
            written: "yes",
            notes: "cove-cache parses and serializes snapshot-bound cache diagnostic records, rejects stale snapshot IDs, duplicate entries, and under-inclusive proof states with cache/ corpus vectors",
        },
        Row {
            section: "§70",
        ...
        Row {
            ...
            validated: "yes",
            written: "n/a",
            notes: "reader fail-closed structural corruption, optional profile/index ignore paths, unknown optional feature acceptance, required feature rejection, MAP/stale/sidecar error fixtures, COVI sidecar mismatch fixtures, and visibility fail-closed fixtures are tagged as recovery evidence",
        },
        Row {
            section: "§75",
        ...
        Row {
            ...
            validated: "yes",
            written: "yes",
            notes: "suite_contract_case corpus verifies the release-gate script contract; direct execution is enforced by scripts/release-gates.sh, including bench/conformance/fuzz smoke and deterministic robustness harness with COVE-AI record-stream coverage",
        },
        Row {
            section: "§80.2",
...
fn main() {
    ...
    out.push_str("# COVE v2.0 Capability Matrix\n\n");
