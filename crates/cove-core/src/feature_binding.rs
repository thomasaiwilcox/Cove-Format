...
pub enum OperationKindV2 {
    ...
    EvidenceReadback = 14,
    AiInspect = 128,
    AiChunkProjection = 129,
    AiTokenProjection = 130,
    AiEmbedding = 131,
    AiSemanticSearch = 132,
    AiRagContext = 133,
    AiTrainingSampleExport = 134,
    AiMultimodalSequenceRead = 135,
    AiGeneratorAudit = 136,
    VendorDefined = 255,
}
...
impl OperationKindV2 {
    pub fn from_u16(value: u16) -> Option<Self> {
        match value {
            ...
            128 => Some(Self::AiInspect),
            129 => Some(Self::AiChunkProjection),
            130 => Some(Self::AiTokenProjection),
            131 => Some(Self::AiEmbedding),
            132 => Some(Self::AiSemanticSearch),
            133 => Some(Self::AiRagContext),
            134 => Some(Self::AiTrainingSampleExport),
            135 => Some(Self::AiMultimodalSequenceRead),
            136 => Some(Self::AiGeneratorAudit),
            255 => Some(Self::VendorDefined),
            _ => None,
        }
    }
