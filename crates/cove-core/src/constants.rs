//! Cove Format (COVE) v2.0 — Constants, magic bytes, feature bits, and enumerations.
//!
//! References:
...
/// Magic bytes at the start of every COVE v2 data file (`b"COV2"`).
pub const MAGIC_COVE: [u8; 4] = *b"COV2";

/// Magic bytes at the start of a COVE v2 footer (`b"CV2F"`).
pub const MAGIC_COVE_FOOTER: [u8; 4] = *b"CV2F";

/// Magic bytes at the end of a COVX v2 accelerator sidecar (`b"CVX2"`).
pub const MAGIC_COVX: [u8; 4] = *b"CVX2";

/// Magic bytes at the end of a COVM v2 dataset manifest (`b"CVM2"`).
pub const MAGIC_COVM: [u8; 4] = *b"CVM2";
...
pub const HEADER_LEN_V1: u16 = 160;
...
/// Required `footer_version` for COVE v2.
pub const FOOTER_VERSION_V1: u16 = 2;
...
/// Postscript version field value for COVE v2.
pub const POSTSCRIPT_VERSION_V1: u16 = 2;
...
pub const FEATURE_CODEC_EXTENSION_REGISTRY: u64 = 0x0000_0000_0400_0000;
pub const FEATURE_REGISTERED_ENCODINGS: u64 = 0x0000_0000_0800_0000;
pub const FEATURE_LAYOUT_PLAN: u64 = 0x0000_0000_1000_0000;
pub const FEATURE_SCAN_SPLIT_INDEX: u64 = 0x0000_0000_2000_0000;
pub const FEATURE_PAGE_CLUSTER_DIRECTORY: u64 = 0x0000_0000_4000_0000;
pub const FEATURE_ZERO_COPY_BUFFER_MAP: u64 = 0x0000_0000_8000_0000;
pub const FEATURE_FAST_METADATA_INDEX: u64 = 0x0000_0001_0000_0000;
pub const FEATURE_RUNTIME_COMPATIBILITY_HINTS: u64 = 0x0000_0002_0000_0000;
pub const FEATURE_EXTENDED_FEATURE_SET: u64 = 0x0000_0004_0000_0000;
pub const FEATURE_CODEC_FALLBACK_PAYLOADS: u64 = 0x0000_0008_0000_0000;
pub const FEATURE_COVERAGE_METADATA: u64 = 0x0000_0010_0000_0000;
pub const FEATURE_COVERAGE_PLAN_CANDIDATES: u64 = 0x0000_0020_0000_0000;
...
pub const KNOWN_FEATURE_BITS_MASK: u64 = FEATURE_OBJECT_PROFILE
    ...
    | FEATURE_CODEC_EXTENSION_REGISTRY
    | FEATURE_REGISTERED_ENCODINGS
    | FEATURE_LAYOUT_PLAN
    | FEATURE_SCAN_SPLIT_INDEX
    | FEATURE_PAGE_CLUSTER_DIRECTORY
    | FEATURE_ZERO_COPY_BUFFER_MAP
    | FEATURE_FAST_METADATA_INDEX
    | FEATURE_RUNTIME_COMPATIBILITY_HINTS
    | FEATURE_EXTENDED_FEATURE_SET
    | FEATURE_CODEC_FALLBACK_PAYLOADS
...
pub enum PrimaryProfile {
    ...
    SemanticMapping = 6,
    /// COVE-CX codec extension carrier.
    CodecExtension = 7,
    /// COVE-L layout/split planning carrier.
    LayoutPlanning = 8,
    /// COVE-R runtime compatibility carrier.
    RuntimeCompatibility = 9,
    /// COVE-COVERAGE coverage metadata carrier.
    CoverageMetadata = 10,
...
impl PrimaryProfile {
    ...
    pub fn from_u8(v: u8) -> Option<Self> {
        match v {
            ...
            7 => Some(Self::CodecExtension),
            8 => Some(Self::LayoutPlanning),
...
pub enum SectionKind {
    ...
    ExtendedFeatureSet = 23,
    CodecExtensionRegistry = 24,
    LayoutPlan = 25,
    ScanSplitIndex = 26,
    PageClusterDirectory = 27,
    ZeroCopyBufferMap = 28,
    FastMetadataIndex = 29,
    ...
    CoverageProviderRegistry = 35,
    CoverageSet = 36,
    CoveragePlanCandidate = 37,
    PredicateNormalForm = 38,
    IndexOnlyCapability = 39,
...
impl SectionKind {
    pub fn from_u16(v: u16) -> Option<Self> {
        match v {
            ...
            23 => Some(Self::ExtendedFeatureSet),
            24 => Some(Self::CodecExtensionRegistry),
            25 => Some(Self::LayoutPlan),
            26 => Some(Self::ScanSplitIndex),
            27 => Some(Self::PageClusterDirectory),
            28 => Some(Self::ZeroCopyBufferMap),
            29 => Some(Self::FastMetadataIndex),
            ...
            35 => Some(Self::CoverageProviderRegistry),
            36 => Some(Self::CoverageSet),
            37 => Some(Self::CoveragePlanCandidate),
            38 => Some(Self::PredicateNormalForm),
            39 => Some(Self::IndexOnlyCapability),
...
mod tests {
    ...
    fn primary_profile_from_u8_all_known() {
        ...
        assert_eq!(
            PrimaryProfile::from_u8(7),
            Some(PrimaryProfile::CodecExtension)
        );
        assert_eq!(
            PrimaryProfile::from_u8(8),
            Some(PrimaryProfile::LayoutPlanning)
        );
        assert_eq!(
            PrimaryProfile::from_u8(9),
            Some(PrimaryProfile::RuntimeCompatibility)
        );
        assert_eq!(
            PrimaryProfile::from_u8(10),
            Some(PrimaryProfile::CoverageMetadata)
        );
        assert_eq!(
