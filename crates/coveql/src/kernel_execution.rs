...
pub(super) fn execution_diagnostics_for_physical(
    physical: &PhysicalPlannedQuery,
...
pub(super) fn aggregate_output_name(name: AstAggregateName) -> &'static str {
    match name {
...
pub(super) fn attach_phase8_plan_reports(
