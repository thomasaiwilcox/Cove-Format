...
- [`v2/docs/customer360-showcase.md`](./v2/docs/customer360-showcase.md): the
...
- [`v2/examples/customer360`](./v2/examples/customer360): checked-in quick
...
cargo run -p cove-cli -- inspect --queries --performance examples/customer360/customers.cove
cargo run -p cove-cli -- query examples/customer360/customers.cove \
